...
import { Link, Loader2, AlertCircle, AlertTriangle, Search, X, ChevronUp, ChevronDown as ChevronDownIcon, ChevronsUpDown, Filter, Check, Columns2, Info, Copy, Trash2, ExternalLink, Bookmark, Pencil, CheckCheck, Navigation2, LayoutList, MapPin, RotateCcw, Eye, EyeOff } from "lucide-react"
        ...
        {isSharedView ? (
          ...
          <div className="ml-auto flex items-center gap-1 shrink-0">
            <Button
              ...
              disabled={loading}
              className="h-7 gap-1.5 text-xs relative text-foreground hover:text-primary"
            >
